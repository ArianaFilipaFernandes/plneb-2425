...
5) Para que a tabela ficasse com o aspeto desejado, recorreu-se mais uma vez à página [DataTables](https://datatables.net/examples/styling/) e à pagina de customização de tabelsa do [Bootstrap](https://getbootstrap.com/docs/5.3/content/tables/). O estilo escolhido foi ```Bootstrap 3```. 
